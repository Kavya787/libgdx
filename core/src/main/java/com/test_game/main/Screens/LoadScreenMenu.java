...
import com.test_game.main.Levels.LevelThree;
import com.test_game.main.Levels.LevelTwo;
...
//         Set the initial screen (e.g., HomeScreen)
                ...
                if(loadedLevel.lvl.equals("two")){
                    ((Core) Gdx.app.getApplicationListener()).setScreen(new LevelTwo(loadedLevel.birds,loadedLevel.pigs,loadedLevel.buildings,loadedLevel.currentBirdIndex));
                }
                if(loadedLevel.lvl.equals("three")){
                        ((Core) Gdx.app.getApplicationListener()).setScreen(new LevelThree(loadedLevel.birds,loadedLevel.pigs,loadedLevel.buildings,loadedLevel.currentBirdIndex));
