...
import com.test_game.main.Pigs.AssPig;
...
public class LevelThree extends Level {
    ...
    private float bird2PushForce = 300f;
    ...
    public LevelThree(ArrayList<Bird>tempBirds,ArrayList<Pig>tempPigs,ArrayList<Block>tempBlocks){
    ...
    private void createPigs(){
        pigs = new ArrayList<>();
        pigs.add(new MediumPig(world, 11, 4));
        pigs.add(new AssPig(world, 13, 3));
    }
...
//        buildings.add(new GlassBlock(world, 10, 3));
//        buildings.add(new GlassBlock(world, 13, 3));
        buildings.add(new SteelBlock(world, 10, 4));
        ...
        buildings.add(new SteelBlock(world, 12, 2));
        buildings.add(new WoodBlock(world, 10, 3));
        ...
        buildings.add(new WoodBlock(world, 10, 5));
...
//        levelSerializer.save(this, fileName);
        ...
        if (bird2PushActive) {
            if(birds.get(currentBirdIndex).getType().equals("black")){
