...
public class LevelTwo extends Level {
    ...
    private void createPigs(){
        pigs = new ArrayList<>();
        pigs.add(new smallPig(world, 11, 4));
        pigs.add(new smallPig(world, 13, 4));
        pigs.add(new MediumPig(world, 12, 3));
    }
    ...
    private void createBuildings() {
        ...
        buildings.add(new GlassBlock(world, 12, 2));
        buildings.add(new GlassBlock(world, 11, 3));
        buildings.add(new WoodBlock(world, 12, 4));
        buildings.add(new WoodBlock(world, 10, 4));
        buildings.add(new WoodBlock(world, 14, 4));
    }
